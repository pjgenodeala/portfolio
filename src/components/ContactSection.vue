<template>
    <section class="text-white mt-20" id="contact">
        ...
        <div class="grid md:grid-cols-2 gap-4 relative px-4 xl:px-16 mt-8" data-aos="zoom-in-up">
            <div>
                <p class="text-[#adb7be]">I’m currently open to new opportunities and would love to hear about any roles 
                    or projects you think I’d be a good fit for. Feel free to reach out—let’s chat!
                </p>
                <div class="col-lg-4 col-md-4 mb-lg-0 mt-5">
                    ...
                    <div class="flex mb-10 items-center">
                        ...
                        <div class="ml-5 text-white">
                            <h4>LinkedIn</h4>
                            <p>https://www.linkedin.com/in/precious-genodeala-591346153/</p>
                        </div>
                    </div>
                </div>
            </div>
