    ...
    <section class="text-white mt-18" id="about">
        ...
        <div class="md:grid md:grid-cols-2 gap-8 items-center py-8 px-4 xl:gap-16 sm:py-16 xl:px-16 z-1">
            ...
            <div class="mt-4 md:mt-0 text-left flex flex-col z-10 h-full" data-aos="flip-right">
                ...
                <p class="text-base lg:text-lg mt-8 py-8">I'm a passionate software developer with a focus on building clean, 
                    efficient, and user-friendly applications. I enjoy working across the full stack, 
                    from crafting responsive frontends with modern frameworks to designing robust backend systems. 
                    I’m always learning and love turning ideas into real-world solutions through code.
                </p>
